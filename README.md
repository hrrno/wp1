...
* International standards for metadata publishing identified
  * MetaData: Dublin core ([ISO 15836](http://www.iso.org/iso/catalogue_detail.htm?csnumber=52142)), [Data Documentation Initiative](http://www.ddialliance.org/),  Directory Interchange Format ('DIF' [ISO 19115](http://www.iso.org/iso/iso_catalogue/catalogue_tc/catalogue_detail.htm?csnumber=53798)), [Norstores Metadata format](https://agora.uninett.no/documents/375288/1356920/Norstore+metadata+schema.pdf), Health Informatics Clinical Metadata ([ISO 13119](http://www.iso.org/iso/catalogue_detail.htm?csnumber=52951)), etc
  * Repository: Metadata Registry Standard ('MDR', [ISO 11179](http://en.wikipedia.org/wiki/ISO/IEC_11179)),  [PREMIS](http://www.loc.gov/standards/premis/), [METS](http://www.loc.gov/standards/mets/METSPrimerRevised.pdf), and [OAI-PMH](http://www.openarchives.org/OAI/openarchivesprotocol.html)
